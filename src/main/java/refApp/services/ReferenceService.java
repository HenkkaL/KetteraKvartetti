...
public class ReferenceService {
    ...
    public void addReference(List<Reference> allReferences, Map<String, String> params) {
        switch (params.get("type")) {
            case "article":
                allReferences.add(new Article(params.get("title"), new Author(params.get("author")), params.get("journal"), params.get("year"), params.get("month"), params.get("volume"), params.get("number"), formPageNo(params.get("pages_start"), params.get("pages_end")), params.get("note"), params.get("reference_id")));
                break;
            case "book":
                ...
                break;
            case "inproceedings":
                allReferences.add(new Inproceedings(params.get("title"), new Author(params.get("author")), params.get("book_title"), params.get("year"), params.get("month"), params.get("editor"), params.get("volume"), params.get("series"), formPageNo(params.get("pages_start"), params.get("pages_end")), params.get("organization"), params.get("publisher"), params.get("address"), params.get("note"), params.get("reference_id")));
                break;
        }
    }
