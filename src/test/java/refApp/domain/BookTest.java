...
public class BookTest {
    ...
    public void setAuthorTest() {
        book.setAuthor(new Author("author test"));
        assertEquals("author test", book.getAuthor().getName());
    }
    ...
    public void testIssetWithEmptyString() {
        Book test = new Book("", new Author("Teppo Kirjailija"), "Tammi", "2001", "12", "", "1", "Series", "", "Satunnaista", "TK01", null);      
        String noText = "";
    ...
    public void testGetTagsForHtmlWithExtraSpace() {
        ...
        Book test = new Book("", new Author("Teppo Kirjailija"), "Tammi", "2001", "12", "", "1", "Series", "", "Satunnaista", "TK01", tags);
